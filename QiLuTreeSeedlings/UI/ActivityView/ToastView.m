...
{
    ToastView *toastView = [[ToastView alloc] initWithText:text withOriginY:originY];
...
{
    ToastView *toastView = [[ToastView alloc] initWithText:text withOriginY:kToastTopYOffset];
