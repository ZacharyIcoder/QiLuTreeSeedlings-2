...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        dataAry =@[@"供应信息",@"求购信息",@"我的收藏",@"信息定制",@"站长助手",@"工程助手",@"合作苗企",@"金牌供应"];
        NSArray *imageAry=@[@"NomerSellMessageBtn",@"NomerBuyMessageBtn",@"NomerMyCollectionBtn",@"NomerCustomBtn",@"zhanzhongtongshouye",@"首页-ico_工程公司",@"首页-ico_工程订单",@"首页-ico_金牌供应商"];
