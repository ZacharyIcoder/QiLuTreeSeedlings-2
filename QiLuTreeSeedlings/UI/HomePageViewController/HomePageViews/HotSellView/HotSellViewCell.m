...
-(id)initWithFrame:(CGRect)frame andDic:(HotSellModel *)Model
{
    ...
    if (self) {
       // self.model=Model;
        ...
        UIImageView *timeImagV=[[UIImageView alloc]initWithFrame:CGRectMake((frame.size.width-80)*0.60+85, 45, 10, 10)];
        [timeImagV setImage:[UIImage imageNamed:@"listtime"]];
        [self addSubview:timeImagV];
        UILabel *timeLab=[[UILabel alloc]initWithFrame:CGRectMake((frame.size.width-80)*0.60+15+85, 40, 70, 20)];
        ...
        UILabel *priceLab=[[UILabel alloc]initWithFrame:CGRectMake((frame.size.width-80)*0.65+20+80, 70, 50, 20)];
