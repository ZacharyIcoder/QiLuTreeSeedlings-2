...
-(id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
       ...
       self.coloectLab=(UILabel *)[shoucangView viewWithTag:1112];
        ...
        UIView *integralView=[self viewWithLLLLLLLImageNmae:@"myintegralImage" andTitle:@"我的积分" andNum:@"0" andFrame:CGRectMake(kWidth/kNum*1, 0, kWidth/kNum, 80)];
        ...
        UIView *myMessageView=[self viewWithLLLLLLLImageNmae:@"MyMessage" andTitle:@"我的消息" andNum:@"0" andFrame:CGRectMake(kWidth/kNum*2, 0, kWidth/kNum, 80)];
